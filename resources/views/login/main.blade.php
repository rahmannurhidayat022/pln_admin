    ...
    <div class="block xl:grid grid-cols-2 gap-4">
        ...
        <div class="hidden xl:flex flex-col min-h-screen">
            ...
            <div class="my-auto">
                <img alt="Midone - HTML Admin Template" class="-intro-x w-1/2 -mt-16"
                    src="{{ asset('build/assets/images/logo_pln.png') }}">
                <div class="-intro-x text-white font-medium text-4xl leading-tight mt-10">Sistem Adminisitrasi<br />
                    Perusahaan Listrik Negara</div>
            </div>
        </div>
        <!-- END: Login Info -->
        <!-- BEGIN: Login Form -->
        <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
            <div
                ...
                <div class="intro-x mt-2 text-slate-400 xl:hidden text-center">Sistem adminisitrasi karyawan PLN.</div>
                <div class="intro-x mt-8">
                    <form id="login-form">
                        <input id="email" type="text" class="intro-x login__input form-control py-3 px-4 block"
                            placeholder="Email" value="admin@pln.com">
